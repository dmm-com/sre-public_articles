...
## 2. 自動生成後に手直しが必要
自動生成したアーキテクチャ図はリソース配置やリソース名が必ずしも分かりやすいものになるとは限りません。
分かりやすいものにするには、自動生成後に個別で修正が必要になります。
...
ただし、自動生成したアーキテクチャ図は手直しが必要な状態です。
アーキテクチャ図を作成する際のたたき台として利用したり、新メンバーがシステム全体を把握する用途で利用するのが良いかと思います。
